...
class TrackRideScreenVm extends BaseVm {
  ...
  onTrackRideProfileClicked(
    ...
    try {
      ...
      // Log the detailed ride information for debugging
      print("Detailed Ride Info Before Navigation: $detailedRideInfo");

      // Navigate to the profile screen with the detailed ride information
      Navigator.pushNamed(
        context,
        TrackRideProfileScreen.route,
