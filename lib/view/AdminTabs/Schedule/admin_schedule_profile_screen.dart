...
import 'admin_schedule_profile_vm.dart';

class AdminScheduleProfileScreen extends StatelessWidget {
  static const route = '/AdminScheduleProfileScreen';

  const AdminScheduleProfileScreen({super.key});

  @override
  Widget build(BuildContext context) {
    return Consumer<AdminScheduleProfileVm>(builder: (context, vm, _) {
      return Scaffold(
        appBar: AppBar(
          leading: IconButton(
