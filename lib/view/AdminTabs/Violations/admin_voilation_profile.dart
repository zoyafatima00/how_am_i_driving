...
import 'admin_violation_profile_vm.dart';

class AdminViolationProfileScreen extends StatelessWidget {
  static const route = '/AdminViolationProfileScreen';

  const AdminViolationProfileScreen({super.key});

  @override
  Widget build(BuildContext context) {
    return Consumer<AdminViolationProfileVm>(builder: (context, vm, _) {
      return Scaffold(
        appBar: AppBar(
          leading: IconButton(
    ...
    return BlueCardWidget(
      ...
      child: Column(
        ...
        children: [
          ...
          _buildDetailRow('Date & Time', '2025-04-07 12:00 AM'),
          Divider(),
          _buildDetailRow('Driver Id', '03'),
          _buildDetailRow('Driver Name', 'Rashid Khan'),
          _buildDetailRow('Vehicle Number', 'RIL-8472'),
          _buildDetailRow('Vehicle Name', 'Suzuki Bolan'),
          Divider(),
          _buildDetailRow('Violation', 'Over Speeding'),
